...
class StreamsTransactionEventHandler(private val router: PersistentActionEventRouter,
                                     private val streamsConstraintsService: StreamsConstraintsService)
    : TransactionEventListener<PreviousTransactionData> {

    private val nodeAll = true
    private val relAll = true
